...
export const ReportCategorization = {
  reportCategories: [
    ...
    {
      categoryName: 'Claim Management Reports',
      reports: [
        {
          reportName: 'claims_status_report',
          reportDisplayName: 'Claims Status Report',
          params: ['startDate', 'endDate', 'clinicIds'], //change this
          roles: ['ROLE_LABORATORY_SERVICE_REPORT'] //change this
        }
      ]
    }
  ]
